        ...
        <div className="footer-body">
          ...
          <div className='b2'>
            <div className='d-flex'>
              ...
              <ul className='footer-links'>
                <h4>Mahsulotlar</h4>
                <li><NavLink to="/products">Paralon (PU) topperlar</NavLink></li>
                <li><NavLink to="/products">Memory Foam topperlar</NavLink></li>
                <li><NavLink to="/products">Memory yostiqlar</NavLink></li>
                <li><NavLink to="/products">Halafayber yostiqlar</NavLink></li>
                <li><NavLink to="/products">Latex yostiqlar</NavLink></li>
                <li><NavLink to="/products">Namatrasniklar</NavLink></li>
                <li><NavLink to="/products">Rafaelo krovat</NavLink></li>
              </ul>
            </div>
          ...
          <div className="footer-bottom">
            <div className='b1'>© 2026 Matras Premier. Barcha huquqlar himoyalangan</div>
            <div className='b2'>Разработка и реклама <a target='_blank' href="https://www.web-marketing.uz/"> WEB MARKETING</a></div>
          </div>
        </div>
